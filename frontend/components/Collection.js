...
export default function Collection() {
  ...
  return (
    <section id="collection" className='w-full  bg-bg-blue flex flex-col items-center text-center'>
       ...
       <p className='px-10 text-xl  text-gray-800  text-justify md:text-2xl font-raleway font-normal my-6'>Each one will be a fully playable character in the Oceans of Terra MMORPG.</p>
