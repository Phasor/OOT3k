  ...
  return (
    <>
      <svg
        ...
        aria-hidden="true"
      >
        <rect width="100%" height="100%" style={{ fill: "rgb(243 244 246)" }} />
        <path
      ...
      <section id="FAQ" class="w-full py-10  bg-bg-dg ">
        <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl flex flex-col justify-center items-center">
          ...
          <div className="bg-white rounded-lg shadow-lg overflow-hidden w-[90%] md:w-[40%] mt-10 sm:mt-20">
            ...
            >
              <p className="text-gray-800 text-xl mt-5 font-lekton">
                April 15th 2023. Narwhalist mint starts at 6am PDT. Public mint
                starts at 10am PDT.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-lg overflow-hidden w-[90%] md:w-[40%] mt-5">
            ...
            >
              <p className="text-gray-800 text-xl mt-5 font-lekton">
                We have an Alpha V1 that has been released and tested within a
                small group. A refined Alpha V2 will be released approximately
                one month after mint date to all NFT holders.
              </p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-lg overflow-hidden w-[90%] md:w-[40%] mt-5">
            ...
            >
              <p className="text-gray-800 text-xl mt-5 font-lekton">
                No. However, we may integrate a token at a later stage of
                development.
              </p>
            </div>
          </div>
