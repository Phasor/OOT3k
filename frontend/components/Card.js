    ...
    <div className="flex flex-col items-center p-4 max-w-[200px]">
      <div className="">
        ...
        <div className="flex justify-between mt-3">
          <p className="text-lg sm:text-xl font-poppins font-medium text-gray-800 mt-2">
            {profile.name}
          </p>
        ...
        <p className="font-raleway font-bold text-md text-gray-800 my-2">
          {profile.role}
        </p>
        <p className="font-raleway text-gray-800 text-l wrap ">
          {profile.description}
        </p>
      </div>
    </div>
