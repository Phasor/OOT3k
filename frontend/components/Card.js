...
export default function Card({profile}) {
  return (
    <div className='max-h-[500px] flex flex-col border border-yellow-500'>
        ...
        <div className='flex justify-between'>
            ...
            <div className='bg-blue-500 h-10 w-10 rounded-lg flex justify-center items-center text-center p-2'>
        ...
        <p className='p-2 text-xl py-0'>{profile.role}</p>
