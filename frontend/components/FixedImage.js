...
export default function FixedImage() {
  ...
  <div className='h-[700px] w-screen bg-[#74acf7] relative'>
    ...
    <p className='hidden sm:block text-lg md:text-2xl font-raleway font-normal text-gray-100 absolute top-[60%] left-[50%] transform -translate-x-1/2 -translate-y-1/2'>Something was brewing many moons away as if someone was analyzing earth's movements day by day. What was on the horizon? Seemingly, no one knew. Yet, our heroes could feel something exciting about to happen. Can you?</p>
    <div className='border border-gray-800 rounded-full text-center bg-[#1B27BF] hover:bg-[#274CCF] cursor-pointer hover:scale-105 text-white font-raleway font-bold text-xl md:text-2xl py-2 px-3 md:px-8 absolute top-[80%] left-[50%] transform -translate-x-1/2 -translate-y-1/2'><Link href="/mint" >Mint Your Terras</Link></div>
