...
export default function FixedImage() {
  ...
  <div className='h-[700px] w-screen bg-[#74acf7] relative'>
    ...
    <div className='border rounded-full text-center bg-[#1B27BF] hover:bg-[#274CCF] cursor-pointer hover:scale-105 text-white font-raleway font-bold text-xl md:text-2xl py-2 px-3 md:px-8 absolute top-[80%] left-[50%] transform -translate-x-1/2 -translate-y-1/2'><Link href="/mint" >Mint Your Terras</Link></div>
