  ...
  return (
        <div className="w-full h-screen flex justify-center items-center bg-[#74acf7] relative">
            <div className='text-center '>
                <p className='font-lucky text-[18vw] md:text-[16vw] lg:text-[12vw] xl:text-[8vw] text-gray-200 drop-shadow-xl'>Oceans</p>
                <p className='font-lucky text-[12vw] md:text-[10vw] lg:text-[8vw] xl:text-[4vw] text-gray-200 drop-shadow-xl'>of</p>
                <p className='font-lucky text-[18vw] md:text-[16vw] lg:text-[12vw] xl:text-[8vw] text-gray-200 drop-shadow-xl'>Terror</p>
            </div>
            <div>
              <Image 
                src="/mermaid.png"
