    ...
    <>
        ...
        <div id="intro" className='w-full bg-[#E5E7EB] flex flex-col lg:flex-row relative'>
            ...
            <div className='flex flex-col items-center justify-center shrink lg:items-end'>
                ...
                <p className="text-2xl text-gray-800 font-medium text-center lg:text-end md:w-[90%] lg:w-[80%] xxl:w-[40%] items-center justify-center lg:justify-start lg:items-start lg:pr-24 px-8 lg:px-4 -mt-4">Oceans of Terra is an underwater adventure game full of magic and wonder. Defend the underwater World against the evil Mermaid Princess, Delila and you shall have life long glory!</p>
            </div>     
        </div>

        <div id="intro" className='w-full bg-[#E5E7EB] flex flex-col justify-center items-center'>
            <p className='text-gray-800 font-leckon text-4xl mt-[16rem] mb-2 p-4 font-semibold'>A JOURNEY OF <span className='text-6xl font-bold'>EPIC PROPORTION </span> BEGINS.</p>
