    ...
    <div className=' bg-[#1C2CC6]'>
        ...
        <div id="intro" className='w-full flex flex-col lg:flex-row relative'>
            <div className='flex flex-col items-center justify-center lg:items-start sm:w-[60%]'>
                <h2 className='text-white font-raleway font-extrabold text-3xl mt-4 sm:text-6xl  lg:w-[80%] 2xl:w-[90%] text-center lg:text-left lg:pl-24 pb-8'>JUMP INTO THE OCEAN</h2>
                <p className="text-white font-raleway font-normal text-2xl md:text-3xl my-4  text-center lg:text-start md:w-[90%] lg:w-[80%] xxl:w-[40%] items-center justify-center lg:justify-start lg:items-start lg:pl-24 px-8 lg:px-4 -mt-4">Oceans of Terra is an underwater adventure game full of magic and wonder. Defend the underwater World against the evil Mermaid Princess, Delila and you shall have life long glory!</p>
            </div>
        ...
        <div id="intro" className='w-full flex flex-col lg:flex-row relative'>
            ...
            <div className='flex flex-col items-center justify-center shrink lg:items-end sm:w-[60%]'>
                <h2 className='text-white font-raleway font-extrabold text-3xl sm:text-6xl mt-4 mb-2 p-4 lg:w-[80%] 2xl:w-[90%] text-center lg:text-right lg:pr-24 pb-8'>A MAGICAL WORLD AWAITS</h2>
                <p className="text-white font-raleway font-normal text-2xl md:text-3xl text-center lg:text-end md:w-[90%] lg:w-[80%] xxl:w-[40%] items-center justify-center lg:justify-start lg:items-start lg:pr-24 px-8 lg:px-4 -mt-4">Oceans of Terra is an underwater adventure game full of magic and wonder. Defend the underwater World against the evil Princess Tytania and get eternal glory!</p>
            </div>  
