...
export default function Team() {
  ...
  const Team = [
    {name: 'HANZBLADE', role: 'Founder', image: '/hanz.jpg', description: "Actively playing video games for over 20 years. 5 years' experience in tech (mobile apps and e-commerce). Spent the last 2 years investing, aping, experimenting, and gaming in the web3 space. Active NFT trader. Degen.", twitter:'https://twitter.com/HanzBlade'},
    {name: 'PHAS0R', role: 'Full-Stack Dev', image: '/phasor.jpg', description: 'Has worked for Barclays, RBS and other large investment funds. Avid gamer (Runescape, Counterstrike, Quake2). Ex Georgia Tech Comp Sci and Oxford University. Tech and Web3 maxi.',twitter:'https://twitter.com/phas0r'},
    {name: 'MIKE', role: 'Game Developer', image: '/decaff.png', description: "10+ years' web & mobile apps development experience. Has built several successful casual games. Unity, Unreal & Godot Game engine Wizard.",twitter:"https://twitter.com/0xdecaff"},
    {name: 'FUHLEENAH', role: 'Creative Lead', image: '/faelina.jpg', description: "East Vancouver OG. Nisga'a, Italian & Scottish. Grew up on Marvel, DC and all things Manga/Anime. An avid lover of poetry and storytelling. Childcare recruiter by day, NFT lore writer by night.",twitter:'https://twitter.com/fuhleenah'},
    {name: 'ALEX', role: 'Game Design', image: '/alex.jpg', description: 'Born in Tokyo. Played golf competitively for 15 years. Passionate gamer and anime super fan. Experienced Game Designer for FIFA at EA games.',twitter:'https://twitter.com/zeroseed_gm'}
  ]
