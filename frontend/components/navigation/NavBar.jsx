...
function NavBar() {
  ...
  return (
    <div>
      <nav className="w-full bg-[#74acf7] opacity-90 absolute sm:fixed top-0 left-0 right-0 z-10">
          ...
          <div>
            ...
            >
              <ul className="h-screen md:h-auto md:flex items-center justify-center">
                <li className="text-2xl text-white font-leckton font-semibold py-5 md:px-6 md:py-1 text-center md:hover:-translate-y-1.5 transition-transform duration-200  hover:bg-[#4b1fcd] md:hover:bg-transparent  border-blue-400">
