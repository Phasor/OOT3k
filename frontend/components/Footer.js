...
export default function Footer() {
  return (
    <div className='w-full overflow-x-hidden overflow-y-hidden bg-[#1B27BF] max-h-[150px]'>
        <div className='w-full max-w-8xl mx-auto flex justify-between'>
            {/* Socials */}
            <div className='flex space-x-4 p-2 ml-2 sm:ml-10'>
                <Link className="flex justify-center items-center hover:scale-105" href="https://twitter.com/OceansOfTerra" target="_blank" >
                    <svg class="text-[#C9E5EB] fill-current h-12 w-12" viewBox="0 0 60 60">
                ...
                <Link className="flex justify-center items-center text-center hover:scale-105" href="https://discord.gg/CBZNXrRVjH" target="_blank" >
                    <svg class="text-[#C9E5EB] fill-current h-8 w-8" viewBox="0 0 90 90">
