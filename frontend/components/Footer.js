...
export default function Footer() {
  return (
    <div className='w-full overflow-x-hidden overflow-y-hidden bg-bg-blue max-h-[150px]'>
        <div className='w-full max-w-8xl mx-auto flex justify-between'>
            ...
            <div className='mr-2 sm:mr-10 font-raleway flex justify-center items-center'>
                <p className='font-raleway font-semibold text-right text-nav-link whitespace-pre'>Copyright Oceans of Terra 2023</p>
