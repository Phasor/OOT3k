      ...
      <div className="mx-auto min-h-[15rem] max-w-[90rem] flex justify-center items-center overflow-x-hidden bg-gray-100 border-t border-gray-200">
        <div className="w-full flex flex-col sm:flex-row justify-between items-center">
          ...
          <div className="flex flex-col items-center justify-center ">
            <p className="font-lekton text-gray-800 text-xl sm:text-2xl font-bold mx-auto">
              Follow Us
            </p>
            <div className="flex justify-center items-center">
              <Link
                className=" hover:scale-105 mr-2"
                href="https://twitter.com/OceansOfTerra"
                target="_blank"
                rel="noopener noreferrer"
              >
                <svg
                  className="text-gray-800 fill-current h-12 w-12"
                  viewBox="0 0 60 60"
                >
              ...
              {/* <Link className=" hover:scale-105 mr-4" href="https://discord.gg/CBZNXrRVjH" target="_blank" rel="noopener noreferrer">
          ...
          <div className="flex flex-col justify-center p-2">
            <p className="font-lekton text-sm sm:text-md sm:font-semibold text-center sm:text-right text-gray-800">
              Copyright Oceans of Terra 2023
            </p>
            <Link href="/terms">
              <p className="font-lekton text-sm sm:text-md sm:font-semibold text-center sm:text-right text-gray-800 underline cursor-pointer">
